...
var OrderComponent = /** @class */ (function () {
    function OrderComponent(checkoutService) {
        this.checkoutService = checkoutService;
        this.order = {};
        this.orderProducts = [];
    }
    ...
    OrderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_checkout_service__WEBPACK_IMPORTED_MODULE_1__["CheckoutService"]])
    ], OrderComponent);
