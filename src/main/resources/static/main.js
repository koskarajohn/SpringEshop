...
var CheckoutPageComponent = /** @class */ (function () {
    function CheckoutPageComponent(authenticationService, cartService) {
        this.authenticationService = authenticationService;
        this.cartService = cartService;
        this.orderDetails = {};
